...
const AboutUs = () => {
  return (
    <div className="grid gap-5 lg:flex lg:gap-20 lg:px-20 justify-center wow slideInleft pt-4" data-wow-duration="2s" data-wow-delay="5s">
        <div className="pt-16 sm:w-2/6 w-full">
            <div className="contents">
                <h3 className="font-starlight font-semibold text-5xl text-blue-500 pb-3 mb-8">About Us</h3>
        ...
        <div className="imagerightside">
            <img className="w-72" src={ sideright1 }/>
        </div>
    </div>
  );
}
